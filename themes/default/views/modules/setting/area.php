	...
	<section class="panel panel-default">
			...
			<div class="row text-sm wrapper">
				<div class="col-sm-4 m-b-xs">
					<a href="<?php echo site_url().'/setting/area_register/'; ?>" class="btn btn-sm btn-info" >Add New Area</a>
				</div>
				<form action="" method="post"> 
				<div class="col-sm-3 pull-right">
					<div class="input-group">
						
						<input type="text" name="q" class="input-sm form-control" placeholder="Search Area"> <span class="input-group-btn">
				...
				<table class="table table-striped m-b-none text-sm">              
					...
					<?php foreach($branch as $c):  ?>
						<tr>     
							...
							<td><?php echo $c->area_code; ?></td>
							<td><?php echo $c->area_name; ?></td>
							<td><?php echo $c->area_leader; ?></td>
							<td class="text-center">
								<!--<a href="<?php echo site_url()."/setting/area_view/".$c->area_id; ?>" title="View"><i class="fa fa-search"></i></a>-->
								<a href="<?php echo site_url()."/setting/area_edit/".$c->area_id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
								<a href="<?php echo site_url()."/setting/area_delete/".$c->area_id; ?>" title="Delete" onclick="return confirmDialog();" ><i class="fa fa-trash-o"></i></a></td>
						</tr>
					<?php $no++; endforeach; ?>
					</tbody>	
				</table>  
