				...
				<table class="table table-striped m-b-none text-sm">              
					...
					<?php if($c->data_status != 4 AND $c->tbl_pembiayaan.deleted!=1 ){ ?>
						<tr>     
							...
							<td class="text-center"><input type="text" name="data_totalangsuranpokok_<?php echo $no; ?>" value="<?php if($c->data_status==1 AND $c->client_pembiayaan_status == 1 AND $c->data_date_first <= $today){ echo number_format(($c->data_plafond/50/1000),1); }else{ echo "0";} ?>" class="inp50  text-right" id="data_totalangsuranpokok_<?php echo $no; ?>" onblur="recalculateSum_angsuranpokok();" readonly /></td>
							...
							<td class="text-right"><?php if($c->tabberjangka_saldo AND $c->tabberjangka_status == 1){ echo number_format(($c->tabberjangka_saldo/1000),1);}else{ echo "0"; } ?></td>
							<td class="text-center"><input type="text" name="data_tabberjangka_debet_<?php echo $no; ?>" value="0" class="inp50 text-right" placeholder="0"  tabindex="11<?php echo $no; ?>" id="data_tabberjangka_debet_<?php echo $no; ?>" onblur="recalculateSum_tabberjangka_debet();" /></td>
							<td class="text-center"><input type="text" name="data_tabberjangka_credit_<?php echo $no; ?>" value="0" class="inp50 text-right" placeholder="0" tabindex="11<?php echo $no; ?>" id="data_tabberjangka_credit_<?php echo $no; ?>" onblur="recalculateSum_tabberjangka_credit();" /></td>
						...
						<input type="hidden" name="data_tabberjangka_totaldebet_<?php echo $no; ?>" value="<?php echo $c->tabberjangka_debet; ?>" >
						<input type="hidden" name="data_tabberjangka_totalcredit_<?php echo $no; ?>" value="<?php echo $c->tabberjangka_credit; ?>">
					...
					<tfoot> 
					  <tr>
						...
						<!--Tabungan Berjangka -->
						<th class="text-right"></th>
						<th class="text-center"><input type="text" name="total_tabberjangka_debet" value="0" class="inp50 text-right" id="total_tabberjangka_setor" /></th>
						<th class="text-center"><input type="text" name="total_tabberjangka_credit" value="0" class="inp50 text-right" id="total_tabberjangka_tarik"/></th>
						<!--Lain -->
...
$(document).ready(function() {
	...
	function recalculateSum_tabberjangka_debet()
	{
		<?php for ($i=1;$i<=$totalno;$i++){ ?>
		var num_<?php echo $i; ?> = parseFloat(document.getElementById("data_tabberjangka_debet_<?php echo $i; ?>").value);
		<?php } ?>
		
		document.getElementById("total_tabberjangka_setor").value =  <?php for ($i=1;$i<=$totalno-1;$i++){ ?> num_<?php echo $i; ?> + <?php } ?>  + num_<?php echo $totalno;?> ;
		recalculateSum_total_tabungan();
		recalculateSum_grandtotal();
	}
	
	function recalculateSum_tabberjangka_credit()
	{
		<?php for ($i=1;$i<=$totalno;$i++){ ?>
		var num_<?php echo $i; ?> = parseFloat(document.getElementById("data_tabberjangka_credit_<?php echo $i; ?>").value);
		<?php } ?>
		
		document.getElementById("total_tabberjangka_tarik").value =  <?php for ($i=1;$i<=$totalno-1;$i++){ ?> num_<?php echo $i; ?> + <?php } ?>  + num_<?php echo $totalno;?> ;
		recalculateSum_total_tabungan();
		recalculateSum_grandtotal();
	}
	...
	{		
		...
		var total_tabberjangka_setor = parseFloat(document.getElementById("total_tabberjangka_setor").value);	
		var total_tabberjangka_tarik = parseFloat(document.getElementById("total_tabberjangka_tarik").value);
		
		document.getElementById("total_tab_setor").value =  total_tabwajib_setor + total_tabsukarela_setor + total_tabberjangka_setor;
		document.getElementById("total_tab_tarik").value  =  total_tabwajib_tarik + total_tabsukarela_tarik + total_tabberjangka_tarik;
		document.getElementById("total_tab_saldo").value  =  total_tabwajib_setor + total_tabsukarela_setor + total_tabberjangka_setor -  (total_tabwajib_tarik + total_tabsukarela_tarik + total_tabberjangka_tarik);	
		//recalculateSum_grandtotal();
	}
