				...
				<table class="table table-striped m-b-none text-sm">              
					...
					<?php foreach($clients as $c): ; ?>
						<tr>     
							...
							?>
							<td class="text-right"><?php if($c->data_sisaangsuran){ echo number_format($sisa_pokok,1); }else{ echo "-";} ; ?></td>							
							<td class="text-right"><?php if($angsuran_profit){ echo number_format($sisa_profit,1); }else{ echo "-";} ; ?></td>
							<td class="text-center"><input type="text" name="data_freq_<?php echo $no; ?>" value="<?php if($c->data_id){ echo "1"; }else{ echo "0";} ?>" class="inp30" id="data_freq_<?php echo $no; ?>" /></td>
							<td class="text-center"><input type="text" name="data_angsuranke_<?php echo $no; ?>" value="<?php if($c->data_id){ echo ($c->data_angsuranke)+1; }else{ echo "0";} ?>" class="inp30" readonly /></td>
							...
							<td class="text-center"><input type="text" name="data_tabwajib_debet_<?php echo $no; ?>" value="1" class="inp50 text-right" placeholder="0" /></td>
							...
							<td class="text-center"><input type="text" name="data_tabsukarela_debet_<?php echo $no; ?>" value="0" class="inp50 text-right" placeholder="0" /></td>
							<td class="text-center"><input type="text" name="data_tabsukarela_credit_<?php echo $no; ?>" value="0" class="inp50 text-right" placeholder="0" /></td>
							...
							<td class="text-center"><input type="text" name="data_adm_<?php echo $no; ?>" value="0" class="inp50 text-right" placeholder="0" /></td>
							<td class="text-center"><input type="text" name="data_butab_<?php echo $no; ?>" value="0" class="inp50 text-right" placeholder="0" /></td>
							<td class="text-center"><input type="text" name="data_lwk_<?php echo $no; ?>" value="0" class="inp50 text-right" placeholder="0" /></td>
							<td class="text-center"><input type="text" name="data_asuransi_<?php echo $no; ?>" value="0" class="inp50 text-right" placeholder="0" /></td>
						</tr>
