			...
			<section class="panel panel-default">
				...
				<div class="table-responsive">					
					<table class="table table-striped m-b-none text-sm">              
						...
						?>
						<?php $no=1; $tsdownload =1; foreach($group_senin as $c):  ?>
					...
					<?php if($no == $tsdownload){ ?>
					<div class="text-center">
						<a href="<?php echo site_url()."/topsheet/ts_download/day/".$c->group_schedule_day; ?>" title="Print All Topsheet" class="btn btn-sm btn-success text-center">Print All Topsheets</a>
					</div>
					<?php } ?>
				</div>				
			</section>
			...
			<section class="panel panel-default">
				...
				<div class="table-responsive">					
					<table class="table table-striped m-b-none text-sm">              
						...
						<tbody>	
						<?php $no=1; $tsdownload =1; foreach($group_selasa as $c):  ?>
						<?php $check = $this->tsdaily_model->check_entry_topsheet($c->group_id, $date_start, $date_end); ?>
							<tr>     
								<td align="center"><?php echo $no; ?></td>
								<td><?php echo $c->group_name; ?></td>
			...
			<section class="panel panel-default">
				...
				<div class="table-responsive">					
					<table class="table table-striped m-b-none text-sm">              
						...
						<tbody>	
						<?php $no=1; $tsdownload =1; foreach($group_rabu as $c):  ?>
						<?php $check = $this->tsdaily_model->check_entry_topsheet($c->group_id, $date_start, $date_end); ?>
							<tr>     
								<td align="center"><?php echo $no; ?></td>
								<td><?php echo $c->group_name; ?></td>
			...
			<section class="panel panel-default">
				...
				<div class="table-responsive">					
					<table class="table table-striped m-b-none text-sm">              
						...
						<tbody>	
						<?php $no=1; $tsdownload =1; foreach($group_kamis as $c):  ?>
						<?php $check = $this->tsdaily_model->check_entry_topsheet($c->group_id, $date_start, $date_end); ?>
							<tr>     
								<td align="center"><?php echo $no; ?></td>
								<td><?php echo $c->group_name; ?></td>
