		...
		<div id="module_title">
			<div class="m-b-md">
				<div class="row">
					...
					<div class="col-lg-6 text-right"><br/><a href="<?php echo site_url();?>/tabsipeci/register" class="btn btn-sm btn-primary">Registrasi Tabungan Sipeci</a></div>
				</div>
			</div>
		</div>
					...
					<table class="table table-striped m-b-none text-sm">      
						...
						<?php foreach($clients as $c):  ?>
							<tr>     
								...
								<td class="text-right"><?php echo number_format($c->tabsipeci_plafond); ?></td>
								<td class="text-center"><?php echo number_format($c->tabsipeci_angsuranke); ?></td>
								<td class="text-right"><?php echo number_format($c->tabsipeci_saldo); ?></td>
								<td class="text-center">
									<a href="<?php echo site_url()."/tabsipeci/tabsipeci_view/".$c->client_account; ?>" title="View"><i class="fa fa-search"></i></a> 
									<?php if($user_level==1){ ?>
									<a href="<?php echo site_url()."/tabsipeci/tabsipeci_edit/".$c->client_account; ?>" title="Edit"><i class="fa fa-pencil"></i></a> 
									<?php } ?>
								</td>
							</tr>
