				...
				<table class="table table-striped m-b-none text-sm">              
					<thead>
					  <tr>
						...
						<th class="text-right">Sampai dengan <?php echo $this->input->post('enddate');?></th>
					  </tr>
					...
					<tbody>	
						...
						<tr> 
							...
							<td class="text-right"> </td>
							<td class="text-right"> </td>
							<td class="text-right"><?php echo number_format($result['total_weekly_kas']); ?></td>
						</tr>
						<tr> 
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rekening RF</td>
							<td class="text-right"> </td>
							<td class="text-right"> </td>
							<td class="text-right"><?php echo number_format($result['total_weekly_rf']); ?></td>
						</tr>
						<tr> 
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rekening Amanah</td>
							<td class="text-right"> </td>
							<td class="text-right"> </td>
							<td class="text-right"><?php echo number_format($result['total_weekly_amanah']); ?></td>
						</tr>
					</tbody>	
				</table>  
			</div>
			<!-- Panel Footer -->
				<div class="panel-footer">
					<div class="form-group">
						<div class="col-sm-3 ">
							<form method="post" action="<?php echo site_url();?>/report/finance_week/laporan_mingguan_download">
