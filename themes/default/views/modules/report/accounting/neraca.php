		...
		<section class="panel panel-default">
			...
			<div class="table-responsive">
				...
				<div class="text-center">
					<br/>
					<a href="<?php echo site_url()."/accounting/download_neraca/"; ?>" target="_blank" class="btn btn-sm btn-primary" >Download Neraca (PDF)</a>
					<a href="<?php echo site_url()."/accounting/neraca_excel/"; ?>" target="_blank" class="btn btn-sm btn-primary" >Download Neraca (Excel)</a>
					<br/><br/>
				</div>
			</div>
