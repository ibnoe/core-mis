				...
				<div class="panel-body">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="personalinfo">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<select name="group_area" class="form-control">
										<?php if(!$data->group_area){ ?>
										<option value="">Pilih Area</option>
										<?php } ?>
										<?php foreach($area as $area):  ?>
										<option value="<?php echo $area->area_id; ?>" <?php if($data->group_area == $area->area_id) { echo "selected";} ?> ><?php echo $area->area_name; ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								<label for="group_address_rw" class="col-sm-3 control-label">Kecamatan</label>
								<div class="col-sm-4">
									<input type="text" name="group_kecamatan" class="form-control" id="group_address_rw" placeholder="" value="<?php echo set_value('group_kecamatan', isset($data->group_kecamatan) ? $data->group_kecamatan : ''); ?>">
								</div>
							</div>
							<div class="form-group">
								<label for="group_address" class="col-sm-3 control-label">Alamat</label>
								<div class="col-sm-4">
									<textarea type="text" name="group_address" class="form-control" id="group_address" ><?php echo set_value('group_address', isset($data->group_address) ? $data->group_address : ''); ?></textarea>
								</div>
							</div>
							<div class="form-group">
								<label for="group_address_rt" class="col-sm-3 control-label">RT</label>
								<div class="col-sm-4">
									<input type="text" name="group_address_rt" class="form-control" id="group_address_rt" placeholder="" value="<?php echo set_value('group_address_rt', isset($data->group_address_rt) ? $data->group_address_rt : ''); ?>">
								</div>
							</div>
							<div class="form-group">
								<label for="group_address_rw" class="col-sm-3 control-label">RW</label>
								<div class="col-sm-4">
									<input type="text" name="group_address_rw" class="form-control" id="group_address_rw" placeholder="" value="<?php echo set_value('group_address_rw', isset($data->group_address_rw) ? $data->group_address_rw : ''); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<select name="group_frequency" class="form-control">
										...
										<option value="2 Mingguan" <?php if($data->group_frequency == "2 Mingguan"){ echo "selected"; } ?>>2 Mingguan</option>
