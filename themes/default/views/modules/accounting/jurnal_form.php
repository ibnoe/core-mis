					...
					<div class="tab-content">
						<div class="tab-pane active" id="personalinfo">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="jurnal_nominal" class="form-control " id="" placeholder="" value="<?php echo set_value('jurnal_nominal', isset($data->jurnal_debet) ? number_format($data->jurnal_debet) : '0'); ?>" />
								</div>
							</div>
							<div class="form-group">
