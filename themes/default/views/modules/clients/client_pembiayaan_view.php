			...
			<div class="panel panel-default">
				...
				<div class="panel-heading">
					...
					<ul class="nav nav-pills">
						<li ><a href="<?php echo site_url()."/clients/summary/".$client->client_id; ?>" >Overview</a></li>
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="pengajuan">
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="data_pengajuan" value="<?php echo set_value('data_pengajuan', isset($data->data_pengajuan) ? $data->data_pengajuan : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Tanggal Pengajuan</label>
								<div class="col-sm-4">
									<input type="text" name="data_tgl" value="<?php echo set_value('data_tgl', isset($data->data_tgl) ? $data->data_tgl : ''); ?>" 	class="form-control datepicker-input" data-date-format="yyyy-mm-dd" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Tujuan Pembiayaan</label>
								<div class="col-sm-4">
									<input type="text" name="data_tujuan" value="<?php echo set_value('data_tujuan', isset($data->data_tujuan) ? $data->data_tujuan : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">PLAFOND (Rp)</label>
								<div class="col-sm-4">
									<input type="text" name="data_plafond" value="<?php echo set_value('data_plafond', isset($data->data_plafond) ? number_format($data->data_plafond) : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="data_akad" class="form-control" value="<?php echo set_value('data_akad', isset($data->data_akad) ? $data->data_akad : ''); ?>" readonly />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="data_totalangsuran" value="<?php echo set_value('data_totalangsuran', isset($data->data_totalangsuran) ? number_format($data->data_totalangsuran) : ''); ?>" class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Pokok (Rp)</label>
								<div class="col-sm-4">
									<input type="text" name="data_angsuranpokok" value="<?php echo set_value('data_angsuranpokok', isset($data->data_angsuranpokok) ? number_format($data->data_angsuranpokok) : ''); ?>" class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Tabungan Wajib (Rp)</label>
								<div class="col-sm-4">
									<input type="text" name="data_tabunganwajib" value="<?php echo set_value('data_tabunganwajib', isset($data->data_tabunganwajib) ? number_format($data->data_tabunganwajib) : ''); ?>" class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Margin/fee (Rp)</label>
								<div class="col-sm-4">
									<input type="text" name="data_margin" value="<?php echo set_value('data_margin', isset($data->data_margin) ? number_format($data->data_margin) : ''); ?>" class="form-control" readonly />
								</div>
							</div>
						</div>
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										...
										<td><input type="text" name="data_pembiayaan1_nama" 	value="<?php echo $data->data_pembiayaan1_nama; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan1_lama" 	value="<?php echo $data->data_pembiayaan1_lama; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan1_plafond" 	value="<?php echo $data->data_pembiayaan1_plafond; ?>"	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan1_total" 	value="<?php echo $data->data_pembiayaan1_total; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan3_status" 	value="<?php echo $data->data_pembiayaan1_status; ?>" 	class="form-control" readonly /></td>
									</tr>
									<tr>
										<td class="text-center">2</td>
										<td><input type="text" name="data_pembiayaan2_nama" 	value="<?php echo $data->data_pembiayaan2_nama; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan2_lama" 	value="<?php echo $data->data_pembiayaan2_lama; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan2_plafond" 	value="<?php echo $data->data_pembiayaan2_plafond; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan2_total" 	value="<?php echo $data->data_pembiayaan2_total; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan2_status" 	value="<?php echo $data->data_pembiayaan2_status; ?>" 	class="form-control" readonly /></td>
									</tr>
									<tr>
										<td class="text-center">3</td>
										<td><input type="text" name="data_pembiayaan3_nama" 	value="<?php echo $data->data_pembiayaan3_nama; ?>" class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan3_lama" 	value="<?php echo $data->data_pembiayaan3_lama; ?>" class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan3_plafond" 	value="<?php echo $data->data_pembiayaan3_plafond; ?>" class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan3_total" 	value="<?php echo $data->data_pembiayaan3_total; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan3_status" 	value="<?php echo $data->data_pembiayaan3_status; ?>" 	class="form-control" readonly /></td>
									</tr>
									<tr>
										<td class="text-center">4</td>
										<td><input type="text" name="data_pembiayaan4_nama" 	value="<?php echo $data->data_pembiayaan4_nama; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan4_lama"	 	value="<?php echo $data->data_pembiayaan4_lama; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan4_plafond" 	value="<?php echo $data->data_pembiayaan4_plafond; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan4_total" 	value="<?php echo $data->data_pembiayaan4_total; ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pembiayaan4_status" 	value="<?php echo $data->data_pembiayaan4_status; ?>" 	class="form-control" readonly /></td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div class="tab-pane" id="family">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="data_suami" class="form-control" value="<?php echo set_value('data_suami', isset($data->data_suami) ? $data->data_suami : ''); ?>" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Tanggal Lahir Suami</label>
								<div class="col-sm-4">
									<input type="text" name="data_suami_tgllahir" class="form-control datepicker-input" data-date-format="yyyy-mm-dd" value="<?php echo set_value('data_suami_tgllahir', isset($data->data_suami_tgllahir) ? $data->data_suami_tgllahir : ''); ?>" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Pekerjaan Suami</label>
								<div class="col-sm-4">
									<input type="text" name="data_suami_pekerjaan" class="form-control" value="<?php echo set_value('data_suami_pekerjaan', isset($data->data_suami_pekerjaan) ? $data->data_suami_pekerjaan : ''); ?>" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Komoditas Suami</label>
								<div class="col-sm-4">
									<input type="text" name="data_suami_komoditas" class="form-control" value="<?php echo set_value('data_suami_komoditas', isset($data->data_suami_komoditas) ? $data->data_suami_komoditas : ''); ?>" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Pendidikan Suami</label>
								<div class="col-sm-4">
									<input type="text" name="data_suami_pendidikan" class="form-control" value="<?php echo set_value('data_suami_pendidikan', isset($data->data_suami_pendidikan) ? $data->data_suami_pendidikan : ''); ?>" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Jumlah Tanggungan</label>
								<div class="col-sm-4">
									<input type="text" name="data_keluarga_tanggungan" class="form-control" value="<?php echo set_value('data_keluarga_tanggungan', isset($data->data_keluarga_tanggungan) ? $data->data_keluarga_tanggungan : ''); ?>" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Jumlah Anak</label>
								<div class="col-sm-4">
									<input type="text" name="data_keluarga_anak" class="form-control" value="<?php echo set_value('data_keluarga_anak', isset($data->data_keluarga_anak) ? $data->data_keluarga_anak : ''); ?>" readonly />
								</div>
							</div>
							<br/>
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										<td><input type="text" name="data_keluarga_belumsekolah" 	value="<?php echo set_value('data_keluarga_belumsekolah', isset($data->data_keluarga_belumsekolah) ? $data->data_keluarga_belumsekolah : ''); ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_keluarga_tidaksekolah" 	value="<?php echo set_value('data_keluarga_tidaksekolah', isset($data->data_keluarga_tidaksekolah) ? $data->data_keluarga_tidaksekolah : ''); ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_keluarga_tk" 				value="<?php echo set_value('data_keluarga_tk', isset($data->data_keluarga_tk) ? $data->data_keluarga_tk : ''); ?>" 								class="form-control" readonly /></td>
										<td><input type="text" name="data_keluarga_sd" 				value="<?php echo set_value('data_keluarga_sd', isset($data->data_keluarga_sd) ? $data->data_keluarga_sd : ''); ?>" 								class="form-control" readonly /></td>
										<td><input type="text" name="data_keluarga_tidaktamatsd" 	value="<?php echo set_value('data_keluarga_tidaktamatsd', isset($data->data_keluarga_tidaktamatsd) ? $data->data_keluarga_tidaktamatsd : ''); ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_keluarga_smp" 			value="<?php echo set_value('data_keluarga_smp', isset($data->data_keluarga_smp) ? $data->data_keluarga_smp : ''); ?>" 								class="form-control" readonly /></td>
										<td><input type="text" name="data_keluarga_sma" 			value="<?php echo set_value('data_keluarga_sma', isset($data->data_keluarga_sma) ? $data->data_keluarga_sma : ''); ?>" 								class="form-control" readonly /></td>
										<td><input type="text" name="data_keluarga_kuliah" 			value="<?php echo set_value('data_keluarga_kuliah', isset($data->data_keluarga_kuliah) ? $data->data_keluarga_kuliah : ''); ?>" 					class="form-control" readonly /></td>										
									</tr>
								</tbody>
							</table>
						...
						<div class="tab-pane" id="asetrt">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="data_aset_lahan" value="<?php echo set_value('data_aset_lahan', isset($data->data_aset_lahan) ? $data->data_aset_lahan : ''); ?>" class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Jumlah Lahan</label>
								<div class="col-sm-4">
									<input type="text" name="data_aset_jumlahlahan" value="<?php echo set_value('data_aset_jumlahlahan', isset($data->data_aset_jumlahlahan) ? $data->data_aset_jumlahlahan : ''); ?>"  class="form-control"  readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Ternak</label>
								<div class="col-sm-4">
									<input type="text" name="data_aset_ternak" value="<?php echo set_value('data_aset_ternak', isset($data->data_aset_ternak) ? $data->data_aset_ternak : ''); ?>"  class="form-control"  readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Jumlah Ternak</label>
								<div class="col-sm-4">
									<input type="text" name="data_aset_jumlahternak" value="<?php echo set_value('data_aset_jumlahternak', isset($data->data_aset_jumlahternak) ? $data->data_aset_jumlahternak : ''); ?>"  class="form-control"  readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Tabungan</label>
								<div class="col-sm-4">
									<input type="text" name="data_aset_tabungan" value="<?php echo set_value('data_aset_tabungan', isset($data->data_aset_tabungan) ? $data->data_aset_tabungan : ''); ?>"  class="form-control"  readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Deposito</label>
								<div class="col-sm-4">
									<input type="text" name="data_aset_deposito" value="<?php echo set_value('data_aset_deposito', isset($data->data_aset_deposito) ? $data->data_aset_deposito : ''); ?>"  class="form-control"  readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Lainnya</label>
								<div class="col-sm-4">
									<input type="text" name="data_aset_lain" value="<?php echo set_value('data_aset_lain', isset($data->data_aset_lain) ? $data->data_aset_lain : ''); ?>"  class="form-control"  readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Total</label>
								<div class="col-sm-4">
									<input type="text" name="data_aset_total"  value="<?php echo set_value('data_aset_total', isset($data->data_aset_total) ? $data->data_aset_total : ''); ?>" class="form-control"  readonly />
								</div>
							</div>
						</div>
						...
						<div class="tab-pane" id="pendapatan">
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										<td>Suami</td>
										<td><input type="text" name="data_pendapatan_suamijenisusaha" 	value="<?php echo set_value('data_pendapatan_suamijenisusaha', isset($data->data_pendapatan_suamijenisusaha) ? $data->data_pendapatan_suamijenisusaha : ''); ?>" class="form-control" readonly /></td>
										<td><input type="text" name="data_pendapatan_suamilama" 					value="<?php echo set_value('data_pendapatan_suamilama', isset($data->data_pendapatan_suamilama) ? $data->data_pendapatan_suamilama : ''); ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pendapatan_suami" 			value="<?php echo set_value('data_pendapatan_suami', isset($data->data_pendapatan_suami) ? $data->data_pendapatan_suami : ''); ?>" 	class="form-control" readonly /></td>
									</tr>
									<tr>
										<td>Istri</td>
										<td><input type="text" name="data_pendapatan_istrijenisusaha" 	value="<?php echo set_value('data_pendapatan_istrijenisusaha', isset($data->data_pendapatan_istrijenisusaha) ? $data->data_pendapatan_istrijenisusaha : ''); ?>" class="form-control" readonly /></td>
										<td><input type="text" name="data_pendapatan_istrilama" 					value="<?php echo set_value('data_pendapatan_istrilama', isset($data->data_pendapatan_istrilama) ? $data->data_pendapatan_istrilama : ''); ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pendapatan_istri" 			value="<?php echo set_value('data_pendapatan_istri', isset($data->data_pendapatan_istri) ? $data->data_pendapatan_istri : ''); ?>" 	class="form-control" readonly /></td>
									</tr>
									<tr>
										<td>Lainny</td>
										<td><input type="text" name="data_pendapatan_lainjenisusaha" 	value="<?php echo set_value('data_pendapatan_lainjenisusaha', isset($data->data_pendapatan_lainjenisusaha) ? $data->data_pendapatan_lainjenisusaha : ''); ?>" class="form-control" readonly /></td>
										<td><input type="text" name="data_pendapatan_lainlama" 			value="<?php echo set_value('data_pendapatan_lainlama', isset($data->data_pendapatan_lainlama) ? $data->data_pendapatan_lainlama : ''); ?>" 	class="form-control" readonly /></td>
										<td><input type="text" name="data_pendapatan_lain" 				value="<?php echo set_value('data_pendapatan_lain', isset($data->data_pendapatan_lain) ? $data->data_pendapatan_lain : ''); ?>" 	class="form-control" readonly /></td>
									</tr>
									
									<tr>
										<td colspan="3">TOTAL</td>
										<td><input type="text" name="data_pendapatan_total" 			value="<?php echo set_value('data_pendapatan_total', isset($data->data_pendapatan_total) ? $data->data_pendapatan_total : ''); ?>" 	class="form-control" readonly /></td>
									</tr>
								</tbody>
							</table>
						...
						<div class="tab-pane" id="pengeluaran">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="data_pengeluaran_beras" value="<?php echo set_value('data_pengeluaran_beras', isset($data->data_pengeluaran_beras) ? $data->data_pengeluaran_beras : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Belanja Dapur</label>
								<div class="col-sm-4">
									<input type="text" name="data_pengeluaran_dapur" value="<?php echo set_value('data_pengeluaran_dapur', isset($data->data_pengeluaran_dapur) ? $data->data_pengeluaran_dapur : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Rekening (listrik, air, tlp)</label>
								<div class="col-sm-4">
									<input type="text" name="data_pengeluaran_rekening" value="<?php echo set_value('data_pengeluaran_rekening', isset($data->data_pengeluaran_rekening) ? $data->data_pengeluaran_rekening : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Pulsa Handphone</label>
								<div class="col-sm-4">
									<input type="text" name="data_pengeluaran_pulsa" value="<?php echo set_value('data_pengeluaran_pulsa', isset($data->data_pengeluaran_pulsa) ? $data->data_pengeluaran_pulsa : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Kreditan</label>
								<div class="col-sm-4">
									<input type="text" name="data_pengeluaran_kreditan" value="<?php echo set_value('data_pengeluaran_kreditan', isset($data->data_pengeluaran_kreditan) ? $data->data_pengeluaran_kreditan : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Arisan</label>
								<div class="col-sm-4">
									<input type="text" name="data_pengeluaran_arisan" value="<?php echo set_value('data_pengeluaran_arisan', isset($data->data_pengeluaran_arisan) ? $data->data_pengeluaran_arisan : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Pendidikan Anak</label>
								<div class="col-sm-4">
									<input type="text" name="data_pengeluaran_pendidikan" value="<?php echo set_value('data_pengeluaran_pendidikan', isset($data->data_pengeluaran_pendidikan) ? $data->data_pengeluaran_pendidikan : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Konsumsi Umum</label>
								<div class="col-sm-4">
									<input type="text" name="data_pengeluaran_umum" value="<?php echo set_value('data_pengeluaran_umum', isset($data->data_pengeluaran_umum) ? $data->data_pengeluaran_umum : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label"> Angs. Pinjaman Lain</label>
								<div class="col-sm-4">
									<input type="text" name="data_pengeluaran_angsuranlain" value="<?php echo set_value('data_pengeluaran_angsuranlain', isset($data->data_pengeluaran_angsuranlain) ? $data->data_pengeluaran_angsuranlain : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Total</label>
								<div class="col-sm-4">
									<input type="text" name="data_pengeluaran_total" value="<?php echo set_value('data_pengeluaran_total', isset($data->data_pengeluaran_total) ? $data->data_pengeluaran_total : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Saving Power</label>
								<div class="col-sm-4">
									<input type="text" name="data_savingpower" value="<?php echo set_value('data_savingpower', isset($data->data_savingpower) ? $data->data_savingpower : ''); ?>" 	class="form-control" readonly />
								</div>
							</div>
						</div>
					</div>
