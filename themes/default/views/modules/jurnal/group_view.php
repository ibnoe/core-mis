					...
					<div class="tab-content">
						<div class="tab-pane active" id="personalinfo">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="group_tpl" class="form-control" id="group_tpl" placeholder="" value="<?php echo set_value('group_tpl', isset($data->group_tpl) ? $data->group_tpl : ''); ?>" readonly />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="group_leader" class="col-sm-2 control-label">Lokasi Pertemuan</label>
								<div class="col-sm-4">
									<input type="text" name="group_location" class="form-control" id="group_location" placeholder="" value="<?php echo set_value('group_location', isset($data->group_location) ? $data->group_location : ''); ?>"  readonly />
								</div>
							</div>
							<div class="form-group">
