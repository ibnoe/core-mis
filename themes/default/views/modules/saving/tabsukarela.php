					...
					<table class="table table-striped m-b-none text-sm">      
						...
						<?php foreach($clients as $c):  ?>
							<tr>     
								...
								<td class="text-right"><?php echo number_format($c->tabsukarela_debet); ?></td>
								<td class="text-right"><?php echo number_format($c->tabsukarela_credit); ?></td>
								<td class="text-right"><?php echo number_format($c->tabsukarela_saldo); ?></td>
								<td class="text-center">
									<a href="<?php echo site_url()."/saving/tabsukarela_view/".$c->client_account; ?>" title="View"><i class="fa fa-search"></i></a> 
									<?php if($user_level==1){ ?>
									<a href="<?php echo site_url()."/saving/tabsukarela_edit/".$c->client_account; ?>" title="Edit"><i class="fa fa-pencil"></i></a> 
									<?php } ?>
								</td>
							</tr>
