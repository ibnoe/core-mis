							...
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td><input type="text" name="client_plafond_<?php echo $i; ?>" 	value="" 	class="inp90 priceformat"></td>
										...
										<td>
											<select name="client_sector_<?php echo $i; ?>" >
												<option value="0" >Sektor</option>
												<?php foreach($sector as $s):  ?>
													<option value="<?php echo $s->sector_id; ?>" ><?php echo $s->sector_name; ?></option>
												<?php endforeach;  ?>
										  </select>
										</td>
