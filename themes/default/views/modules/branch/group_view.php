					...
					<div class="tab-content">
						<div class="tab-pane active" id="personalinfo">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="group_address_rt" class="form-control" id="group_address_rt" placeholder="" value="<?php echo set_value('group_address_rt', isset($data->group_address_rt) ? $data->group_address_rt : ''); ?>" readonly>
								</div>
							</div>
							<div class="form-group">
								<label for="group_address_rw" class="col-sm-3 control-label">RW</label>
								<div class="col-sm-4">
									<input type="text" name="group_address_rw" class="form-control" id="group_address_rw" placeholder="" value="<?php echo set_value('group_address_rw', isset($data->group_address_rw) ? $data->group_address_rw : ''); ?>" readonly>
								</div>
							</div>
							<div class="form-group">
