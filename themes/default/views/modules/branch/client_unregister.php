							...
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<select name="client_alasan_<?php echo $i; ?>" id="client_alasan_<?php echo $i; ?>">
												<option value="0" >Pilih Alasan Keluar</option>
												<?php foreach($alasan as $a):  ?>
													<option value="<?php echo $a->alasan_id; ?>" ><?php echo $a->alasan_name; ?></option>
												<?php endforeach;  ?>
											</select>
											<!--<input type="text" name="client_alasan_<?php echo $i; ?>" 	value="" 	class="inp90" ></td>-->
...
$(document).ready(function() {
	<?php for ($i=0;$i<=30;$i++){ ?>
		...
		$("#client_group_<?php echo $i; ?>").change(function() { 
			  ...
			  $.ajax({
					url: "<?php echo site_url('branch/getclient2'); ?>",
					type: 'POST',
					dataType: 'json',
					data: form_data,
