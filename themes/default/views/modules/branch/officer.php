	...
	<section class="panel panel-default">
			...
			<div class="row text-sm wrapper">
				<div class="col-sm-4 m-b-xs">
					<a href="<?php echo site_url().'/branch/officer_create/'; ?>" class="btn btn-sm btn-info" ><i class="fa fa-plus"></i> Registrasi Pendamping Lapangan</a>
				</div>
				<form action="" method="post"> 
				<div class="col-sm-3 pull-right">
					<div class="input-group">						
						<input type="text" name="q" class="input-sm form-control" placeholder="Search"> <span class="input-group-btn">
			...
			<div class="table-responsive">  
				...
				<table class="table table-striped m-b-none text-sm">              
					<thead>                  
					  <tr>
						<th width="30px">No</th>
						<th>Nama Pendamping Lapangan</th>
						<th>N I P</th>
						<th>Jumlah Majelis</th>
						<th>Cabang</th>
