					...
					<div class="tab-content">
						<div class="tab-pane active" id="personalinfo">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<select name="user_branch" class="form-control" >
										...
										<?php } ?>
										<option value="0" <?php if($data->user_branch == 0) { echo "selected";} ?>>Pusat</option>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="username" class="form-control" id="group_name" placeholder="" <?php if($user_level!=1){echo "readonly";} ?> value="<?php echo set_value('username', isset($data->username) ? $data->username : ''); ?>" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<select name="user_level" class="form-control">
										...
										<option value="5" <?php if($data->user_level == "5"){ echo "selected"; } ?>>Finance</option>
