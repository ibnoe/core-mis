...
class clients_pembiayaan_model extends MY_Model {
	...
	public function get_all_pencairan($limit, $offset, $search='', $key='')
	{
		if($search != '')
		{
			return $this->db->select('*')
	...
	public function get_all_pencairan_by_branch($limit, $offset, $search='', $key='', $branch)
	{
		if($search != '')
		{
			return $this->db->select('*')
	...
	public function count_all_pencairan_by_branch($search,$branch)
	{
		return $this->db->select("count(*) as numrows")
						->from('tbl_clients')
						->where('tbl_clients.client_branch',$branch)
	...
	public function count_all_pencairan($search)
	{
		return $this->db->select("count(*) as numrows")
						->from('tbl_clients')
						->where('tbl_clients.client_pembiayaan_status','1')
