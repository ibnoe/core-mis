	...
	*/
	...
	public function ts_delete(){
		...
		foreach($data as $c){
			...
			/**/
			//UPDATE tbl_tabberjangka
				//Get TabBerjangka Actual
				$detail_tabberjangka = $this->tabberjangka_model->get_tabberjangka($tr_account);
				$detail_tabberjangka = $detail_tabberjangka[0];
				//Set Tabberjangka Value
				$tabberjangka_debet  = $detail_tabberjangka->tabberjangka_debet  - $tr_tabberjangka_debet;
				$tabberjangka_credit = $detail_tabberjangka->tabberjangka_credit - $tr_tabberjangka_credit;
				$tabberjangka_saldo  = $detail_tabberjangka->tabberjangka_saldo  - $tr_tabberjangka_debet + $tr_tabberjangka_credit;
				//Update Table
				$saving_date = date("Y-m-d H:i:s");
				$data_tabberjangka = array(
						'tabberjangka_date'      =>  $saving_date,
						'tabberjangka_debet'     =>  $tabberjangka_debet,
						'tabberjangka_credit'    =>  $tabberjangka_credit,
						'tabberjangka_saldo'     =>  $tabberjangka_saldo,
						'tabberjangka_angsuranke' => $detail_tabberjangka->tabberjangka_angsuranke - 1
				);				
				$this->tabberjangka_model->update($tr_account, $data_tabberjangka); 
		...
		$this->transaction_model->delete_tr_tabberjangka($id,$data_transaction);
	...
	public function tsdaily_apel_download(){
		if($this->session->userdata('logged_in'))
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValue("H4", "TABUNGAN BERJANGKA");
				$objPHPExcel->getActiveSheet()->getColumnDimension("H")->setWidth(15);
				$objPHPExcel->getActiveSheet()->getColumnDimension("I")->setWidth(15);
				$objPHPExcel->getActiveSheet()->mergeCells("H4:I4");
				$objPHPExcel->getActiveSheet()->setCellValue("H5", "KREDIT");
				$objPHPExcel->getActiveSheet()->setCellValue("I5", "DEBET");
				
			$objPHPExcel->getActiveSheet()->setCellValue("J4", "TOTAL RF");
				$objPHPExcel->getActiveSheet()->getColumnDimension("J")->setWidth(15);
				$objPHPExcel->getActiveSheet()->mergeCells("J4:J5");
			$objPHPExcel->getActiveSheet()->setCellValue("K4", "TOTAL TABUNGAN");
				$objPHPExcel->getActiveSheet()->getColumnDimension("K")->setWidth(15);
				$objPHPExcel->getActiveSheet()->mergeCells("K4:K5");
			$objPHPExcel->getActiveSheet()->setCellValue("L4", "GRAND TOTAL");
				$objPHPExcel->getActiveSheet()->getColumnDimension("L")->setWidth(15);
				$objPHPExcel->getActiveSheet()->mergeCells("L4:L5");
			$objPHPExcel->getActiveSheet()->setCellValue("M4", "ABSENSI");
				...
				$objPHPExcel->getActiveSheet()->mergeCells("M4:Q4");
				$objPHPExcel->getActiveSheet()->setCellValue("M5", "H");
				$objPHPExcel->getActiveSheet()->setCellValue("N5", "S");
				$objPHPExcel->getActiveSheet()->setCellValue("O5", "C");
				$objPHPExcel->getActiveSheet()->setCellValue("P5", "I");
				$objPHPExcel->getActiveSheet()->setCellValue("Q5", "A");
			$objPHPExcel->getActiveSheet()->setCellValue("R4", "TOTAL ANGGOTA");
				$objPHPExcel->getActiveSheet()->mergeCells("R4:R5");
			$objPHPExcel->getActiveSheet()->setCellValue("S4", "TOTAL TR");
				$objPHPExcel->getActiveSheet()->mergeCells("S4:S5");
			
			$objPHPExcel->getActiveSheet()->getStyle('A4:S5')->getAlignment()->setWrapText(true); 
			
			$objPHPExcel->getActiveSheet()->getStyle("K4:S5")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
			...
			foreach($tsdaily as $c):
				...
				if($tgl_start != $tgl_end AND $no==1){
					...
					$objPHPExcel->getActiveSheet()->setCellValue("H$cell_no", $total_tabungan_berjangka_debet);
					$objPHPExcel->getActiveSheet()->setCellValue("I$cell_no", $total_tabungan_berjangka_credit);
					$objPHPExcel->getActiveSheet()->setCellValue("J$cell_no", $total_total_rf);
					$objPHPExcel->getActiveSheet()->setCellValue("K$cell_no", $total_total_tabungan);
					$objPHPExcel->getActiveSheet()->setCellValue("L$cell_no", $total_total_tabungan + $total_total_rf);
					$objPHPExcel->getActiveSheet()->setCellValue("M$cell_no", $total_absen_h);
					$objPHPExcel->getActiveSheet()->setCellValue("N$cell_no", $total_absen_s);
					$objPHPExcel->getActiveSheet()->setCellValue("O$cell_no", $total_absen_c);
					$objPHPExcel->getActiveSheet()->setCellValue("P$cell_no", $total_absen_i);
					$objPHPExcel->getActiveSheet()->setCellValue("Q$cell_no", $total_absen_a);
					$objPHPExcel->getActiveSheet()->setCellValue("R$cell_no", $total_transaction);
					$objPHPExcel->getActiveSheet()->setCellValue("S$cell_no", $total_tr);
					$objPHPExcel->getActiveSheet()->getStyle("B$cell_no:O$cell_no")->applyFromArray(array("font" => array( "bold" => true)));
					$objPHPExcel->getActiveSheet()->getStyle("C$cell_no:L$cell_no")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
					$objPHPExcel->getActiveSheet()->getStyle("M$cell_no:Q$cell_no")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
					$cell_no++;
					$objPHPExcel->getActiveSheet()->mergeCells("B$cell_no:Q$cell_no");
					$header_day = $this->namahari($c->tsdaily_date);
					$header = $header_day.", ".date('d-M-Y',strtotime($c->tsdaily_date));
					$objPHPExcel->getActiveSheet()->setCellValue("B$cell_no", $header);
					$objPHPExcel->getActiveSheet()->getStyle("B$cell_no")->applyFromArray(array("font" => array( "bold" => true)));
				...
				$total_total_rf += $c->tsdaily_total_rf + $c->tsdaily_tabwajib;
				$total_total_tabungan += $c->tsdaily_total_tabungan - $c->tsdaily_tabwajib;
				...
				$objPHPExcel->getActiveSheet()->setCellValue("M$cell_no", $c->tsdaily_absen_h);
				$objPHPExcel->getActiveSheet()->setCellValue("N$cell_no", $c->tsdaily_absen_s);
				$objPHPExcel->getActiveSheet()->setCellValue("O$cell_no", $c->tsdaily_absen_c);
				$objPHPExcel->getActiveSheet()->setCellValue("P$cell_no", $c->tsdaily_absen_i);
				$objPHPExcel->getActiveSheet()->setCellValue("Q$cell_no", $c->tsdaily_absen_a);
				$objPHPExcel->getActiveSheet()->setCellValue("R$cell_no", $c->tsdaily_total_transaction);
				$objPHPExcel->getActiveSheet()->setCellValue("S$cell_no", $c->tsdaily_total_tr);
				$objPHPExcel->getActiveSheet()->getStyle("C$cell_no:L$cell_no")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
				$objPHPExcel->getActiveSheet()->getStyle("M$cell_no:Q$cell_no")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
			...
			endforeach;
				...
				$objPHPExcel->getActiveSheet()->setCellValue("R$cell_no", $total_transaction);
				$objPHPExcel->getActiveSheet()->setCellValue("S$cell_no", $total_tr);
				$objPHPExcel->getActiveSheet()->getStyle("B$cell_no:Q$cell_no")->applyFromArray(array("font" => array( "bold" => true)));
				$objPHPExcel->getActiveSheet()->getStyle("C$cell_no:L$cell_no")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
				$objPHPExcel->getActiveSheet()->getStyle("M$cell_no:O$cell_no")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
				$cell_no++;
