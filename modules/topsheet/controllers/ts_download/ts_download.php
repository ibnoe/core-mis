...
class Ts_download extends Front_Controller{
	...
	public function day(){			
		...
		$schedule = $this->group_model->get_schedule($user_branch, $day);
		foreach ($schedule as $day){
			...
			*/
			...
			$html .= '<tr>';
				...
				$html .= '<td rowspan="5" class="nobdr" >&nbsp;</td>'; //space
				...
				//$html .= '<td class="nobdr"></td>';
				$html .= '<td colspan="3" class="bdr_btm_bold">Tab Sukarela</td>'; //eks tab wajib
		...
		//foreach ($schedule as $day){
			...
			*/
			...
			if($c->data_status != 4){
				...
				$html .= '<td align="center" class="bdr_btm">'.$data_tabberjangka_ke.'</td>';
				$html .= '<td align="right" class="bdr_btm">'.$data_tabberjangka.'</td>';
				$html .= '<td align="right" class="bdr_leftbtm">a'.$data_tabberjangka_plafond.'</td>';
				$html .= '<td class="bdr_leftbtm">&nbsp;</td>';
				$html .= '<td class="nobdr" width="2px">&nbsp;</td>';
				$html .= '<td class="bdr_btm">&nbsp;</td>';				
				$html .= '</tr>';
