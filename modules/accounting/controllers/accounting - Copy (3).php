	...
	public function neraca()
	{
		if($this->session->userdata('logged_in'))
		{
			...
			foreach($accounting as $c):
				...
				if($haschild == "1" AND $parent == "0"){
					...
					$grand_total_before += $account_saldo_before;
						...
						$grand_total_hutang_debet += $account_debet;
						$grand_total_hutang_credit += $account_credit;
						$grand_total_hutang_before += $account_saldo_before;					
			...
			endforeach; 	
				...
				$grand_total_hutang_saldo = $grand_total_hutang_before+$grand_total_hutang_debet-$grand_total_hutang_credit;
				$neraca .= '<tr bgcolor="#eee">     
							<td align="left" ><b>TOTAL HUTANG</b></td>	
							<td class="text-right"><b>'.($grand_total_hutang_before < 0 ? "(".number_format(abs($grand_total_hutang_before)).")" : number_format($grand_total_hutang_before)).'</b></td>
							<td class="text-right"><b>'.number_format($grand_total_hutang_debet).'</b></td>
							<td class="text-right"><b>'.number_format($grand_total_hutang_credit).'</b></td>
							<td class="text-right"><b>'.($grand_total_hutang_saldo < 0 ? "(".number_format(abs($grand_total_hutang_saldo)).")" : number_format($grand_total_hutang_saldo)).'</b></td>
							</tr>';	
